...
namespace bflex.facturacion.Sunat {
    ...
    public interface billService {
        ...
        bflex.facturacion.Sunat.getStatusResponse getStatus(bflex.facturacion.Sunat.getStatusRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:getStatus", ReplyAction="*")]
        System.Threading.Tasks.Task<bflex.facturacion.Sunat.getStatusResponse> getStatusAsync(bflex.facturacion.Sunat.getStatusRequest request);
        ...
        bflex.facturacion.Sunat.sendBillResponse sendBill(bflex.facturacion.Sunat.sendBillRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendBill", ReplyAction="*")]
        System.Threading.Tasks.Task<bflex.facturacion.Sunat.sendBillResponse> sendBillAsync(bflex.facturacion.Sunat.sendBillRequest request);
        ...
        bflex.facturacion.Sunat.sendPackResponse sendPack(bflex.facturacion.Sunat.sendPackRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendPack", ReplyAction="*")]
        System.Threading.Tasks.Task<bflex.facturacion.Sunat.sendPackResponse> sendPackAsync(bflex.facturacion.Sunat.sendPackRequest request);
        
        // CODEGEN: El parámetro 'ticket' requiere información adicional de esquema que no se puede capturar con el modo de parámetros. El atributo específico es 'System.Xml.Serialization.XmlElementAttribute'.
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendSummary", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [return: System.ServiceModel.MessageParameterAttribute(Name="ticket")]
        bflex.facturacion.Sunat.sendSummaryResponse sendSummary(bflex.facturacion.Sunat.sendSummaryRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendSummary", ReplyAction="*")]
        System.Threading.Tasks.Task<bflex.facturacion.Sunat.sendSummaryResponse> sendSummaryAsync(bflex.facturacion.Sunat.sendSummaryRequest request);
    }
    ...
    public partial class getStatusResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.sunat.gob.pe", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public bflex.facturacion.Sunat.statusResponse status;
        
        public getStatusResponse() {
        }
        
        public getStatusResponse(bflex.facturacion.Sunat.statusResponse status) {
            this.status = status;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface billServiceChannel : bflex.facturacion.Sunat.billService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class billServiceClient : System.ServiceModel.ClientBase<bflex.facturacion.Sunat.billService>, bflex.facturacion.Sunat.billService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bflex.facturacion.Sunat.getStatusResponse bflex.facturacion.Sunat.billService.getStatus(bflex.facturacion.Sunat.getStatusRequest request) {
            return base.Channel.getStatus(request);
        }
        
        public bflex.facturacion.Sunat.statusResponse getStatus(string ticket) {
            bflex.facturacion.Sunat.getStatusRequest inValue = new bflex.facturacion.Sunat.getStatusRequest();
            inValue.ticket = ticket;
            bflex.facturacion.Sunat.getStatusResponse retVal = ((bflex.facturacion.Sunat.billService)(this)).getStatus(inValue);
            return retVal.status;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<bflex.facturacion.Sunat.getStatusResponse> bflex.facturacion.Sunat.billService.getStatusAsync(bflex.facturacion.Sunat.getStatusRequest request) {
            return base.Channel.getStatusAsync(request);
        }
        
        public System.Threading.Tasks.Task<bflex.facturacion.Sunat.getStatusResponse> getStatusAsync(string ticket) {
            bflex.facturacion.Sunat.getStatusRequest inValue = new bflex.facturacion.Sunat.getStatusRequest();
            inValue.ticket = ticket;
            return ((bflex.facturacion.Sunat.billService)(this)).getStatusAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bflex.facturacion.Sunat.sendBillResponse bflex.facturacion.Sunat.billService.sendBill(bflex.facturacion.Sunat.sendBillRequest request) {
            return base.Channel.sendBill(request);
        }
        
        public byte[] sendBill(string fileName, byte[] contentFile, string partyType) {
            bflex.facturacion.Sunat.sendBillRequest inValue = new bflex.facturacion.Sunat.sendBillRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            bflex.facturacion.Sunat.sendBillResponse retVal = ((bflex.facturacion.Sunat.billService)(this)).sendBill(inValue);
            return retVal.applicationResponse;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<bflex.facturacion.Sunat.sendBillResponse> bflex.facturacion.Sunat.billService.sendBillAsync(bflex.facturacion.Sunat.sendBillRequest request) {
            return base.Channel.sendBillAsync(request);
        }
        
        public System.Threading.Tasks.Task<bflex.facturacion.Sunat.sendBillResponse> sendBillAsync(string fileName, byte[] contentFile, string partyType) {
            bflex.facturacion.Sunat.sendBillRequest inValue = new bflex.facturacion.Sunat.sendBillRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            return ((bflex.facturacion.Sunat.billService)(this)).sendBillAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bflex.facturacion.Sunat.sendPackResponse bflex.facturacion.Sunat.billService.sendPack(bflex.facturacion.Sunat.sendPackRequest request) {
            return base.Channel.sendPack(request);
        }
        
        public string sendPack(string fileName, byte[] contentFile, string partyType) {
            bflex.facturacion.Sunat.sendPackRequest inValue = new bflex.facturacion.Sunat.sendPackRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            bflex.facturacion.Sunat.sendPackResponse retVal = ((bflex.facturacion.Sunat.billService)(this)).sendPack(inValue);
            return retVal.ticket;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<bflex.facturacion.Sunat.sendPackResponse> bflex.facturacion.Sunat.billService.sendPackAsync(bflex.facturacion.Sunat.sendPackRequest request) {
            return base.Channel.sendPackAsync(request);
        }
        
        public System.Threading.Tasks.Task<bflex.facturacion.Sunat.sendPackResponse> sendPackAsync(string fileName, byte[] contentFile, string partyType) {
            bflex.facturacion.Sunat.sendPackRequest inValue = new bflex.facturacion.Sunat.sendPackRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            return ((bflex.facturacion.Sunat.billService)(this)).sendPackAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bflex.facturacion.Sunat.sendSummaryResponse bflex.facturacion.Sunat.billService.sendSummary(bflex.facturacion.Sunat.sendSummaryRequest request) {
            return base.Channel.sendSummary(request);
        }
        
        public string sendSummary(string fileName, byte[] contentFile, string partyType) {
            bflex.facturacion.Sunat.sendSummaryRequest inValue = new bflex.facturacion.Sunat.sendSummaryRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            bflex.facturacion.Sunat.sendSummaryResponse retVal = ((bflex.facturacion.Sunat.billService)(this)).sendSummary(inValue);
            return retVal.ticket;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<bflex.facturacion.Sunat.sendSummaryResponse> bflex.facturacion.Sunat.billService.sendSummaryAsync(bflex.facturacion.Sunat.sendSummaryRequest request) {
            return base.Channel.sendSummaryAsync(request);
        }
        
        public System.Threading.Tasks.Task<bflex.facturacion.Sunat.sendSummaryResponse> sendSummaryAsync(string fileName, byte[] contentFile, string partyType) {
            bflex.facturacion.Sunat.sendSummaryRequest inValue = new bflex.facturacion.Sunat.sendSummaryRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            return ((bflex.facturacion.Sunat.billService)(this)).sendSummaryAsync(inValue);
        }
    }
}
